...
export default {
    ...
    methods:{
        loadData(){
             let url="http://123.57.92.11:6677/customer/findAll"
        ...
        submitHandler(){
            ...
            let url="http://123.57.92.11:6677/customer/saveOrUpdate"
            request({
                url,
                method:"POST",
                headers:{
        ...
        toDeleteHandler(id){
          ...
          //调用后台接口完成删除操作
          let url="http://123.57.92.11:6677/customer/deleteById?id="+id;
          request.get(url).then((response)=>{
              //刷新数据
                this.loadData();
              //提示结果
